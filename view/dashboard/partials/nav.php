<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html">MEA IEEE Student Branch</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="/dashboard/events"><i class="fa fa-calendar fa-fw"></i> View All Events</a>
                </li>
                <li>
                ...
                <li>
                    <a href="/dashboard/upload-image"><i class="fa fa-file-image-o fa-fw"></i> Upload Image</a>
                </li>
            </ul>
        </div>
        <!-- /.sidebar-collapse -->
