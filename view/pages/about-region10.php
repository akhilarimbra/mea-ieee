<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="ui breadcrumb hidden-sm-down">
        ...
        <div class="divider"> / </div>
        <div class="active section">Region 10</div>
      </div>
    </div>
  </div>
  <hr>
  <div class="row">
    <div class="col-lg-12">
      <img width='100%' src='/public/images/r10.jpg'></img>
      <br>
      <h3 class="article-title">Asia Pacific Region</h3>
      ...
      <p class="article-content">
        ...
        <li>To formulate goals and objectives for the Region.</li>
        <li>To plan Regional operations, including budget preparation and approval.</li>
        <li>To report officer, financial operation and meeting reports to the Regional Activities Department.</li>
        <li>To plan and implement programs in support of the local organizational units in meeting the needs of the members of the Region.</li>
        <li>To plan and implement programs for the volunteer structure of the Region, for example, develop and implement leadership training programs for volunteers and members to enhance their interpersonal skills, group skills and leadership abilities.</li>
        <li>To provide leadership opportunities for interested members to take an active role within the operations of the Region.</li>
        </ul>
      </p>
    </div>
  </div>
