<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="ui breadcrumb hidden-sm-down">
        ...
        <div class="divider"> / </div>
        <div class="active section">IEEE</div>
      </div>
    </div>
  </div>
  <hr>
  <div class="row">
    <div class="col-lg-12">
      <img width='100%' class="shadow-effect" src='/public/images/ieee-header.jpg'></img>
    </div>
  </div>
  <br>
  <div class="row">
      <div class="col-lg-6">
        <h3 class='article-title'>IEEE</h3>
        <p class='article-content'>
          ...
          The IEEE publishes a third of the world’s technical literature in electrical engineering,
          computer science and electronics and is a leading developer of international standards that underpin many of today's telecommunications,
          information technology and power generation products and services.
        </p>
      </div>
      <div class="col-lg-6">
        <h3 class='article-title'>History</h3>
        <p class='article-content'>
  ...
  <div class="row">
    <div class="col-lg-12">
      <img class="img-responsive shadow-effect" width='100%' src='/public/images/ieee-banner.png'></img>
    </div>
  </div>
  <br>
  <div class="row">
      <div class="col-lg-6">
        <h3 class='article-title'>Meaning</h3>
        <p class='article-content'>
      ...
      <div class="col-lg-6">
        <h3 class='article-title'>Foundation</h3>
        <p class='article-content'>
  ...
  <div class="row">
    <div class="col-lg-12">
      <h3 class="article-title">Growth and globalization</h3>
      <p class="article-content">
  ...
  <div class="row">
    <div class="col-lg-12">
      <img src='/public/images/ieee-day.jpg' class="shadow-effect" width='100%'></img>
    </div>
  </div>
  <br>
</div>
